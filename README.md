...
فایل‌های اجرایی کوچک موجود در ریشه فقط لانچر سازگاری‌اند تا Shortcutها و Scheduled Taskهای قدیمی پس از تغییر ساختار همچنان کار کنند؛ پیاده‌سازی اصلی آن‌ها داخل `apps/` قرار دارد.
